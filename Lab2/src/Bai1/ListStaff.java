...
public class ListStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"NV001", "Nguyễn Nghiệm", "VN", "Male", "Married"},
                {"NV002", " Lê Thị Hương Thảo", "SG", "Female", "Married"},
                {"NV003", "Nguyễn Đình Thiên Long", "US", "Male", "Single"},
                {"NV004", "Nguyễn Đình Hoàng Long", "MA", "Male", "Single"}
            },
            new String [] {
